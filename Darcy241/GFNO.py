...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2,  width): # 12, 12, 32
...
TRAIN_PATH = './piececonst_r241_N1024_smooth1.mat'
TEST_PATH = './piececonst_r241_N1024_smooth2.mat'
...
################################################################
model = FNO2d(modes, modes, width).cuda() # 12, 12, 32
